...
bool Intersects(const std::vector<Point>& a, const std::vector<Point>& b)
{
 return a.size() > b.size() ? LinesIntersects(a, b) :
                                          LinesIntersects(b, a); 
}


bool LinesIntersects(const std::vector<Point>& lines1, const std::vector<Point>& lines2)
  {
